...
Reference full template: `E:/nt170/wallhack/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/nt170/wallhack/.opencode/get-shit-done/templates/state.md`.
