...
<reference>
@E:/nt170/wallhack/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/nt170/wallhack/.opencode/get-shit-done/references/user-profiling.md` to load:
