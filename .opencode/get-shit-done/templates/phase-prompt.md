...
<!-- For checkpoint task examples and patterns, see @E:/nt170/wallhack/.opencode/get-shit-done/references/checkpoints.md -->
...
See `E:/nt170/wallhack/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/nt170/wallhack/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/nt170/wallhack/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
