...
- **Global scope**: `E:/nt170/wallhack/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/nt170/wallhack/.opencode/notes/`)
...
2. Glob `E:/nt170/wallhack/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (E:/nt170/wallhack/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/nt170/wallhack/.opencode/notes/` — works in any directory
