...
```
Task(
  prompt="Read E:/nt170/wallhack/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/nt170/wallhack/.opencode/get-shit-done/templates/SECURITY.md`
