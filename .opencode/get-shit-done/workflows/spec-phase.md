...
```bash
INIT=$(node "E:/nt170/wallhack/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/nt170/wallhack/.opencode/get-shit-done/templates/spec.md.
