...
INSTALL_JS_GLOBAL="E:/nt170/wallhack/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/nt170/wallhack/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
