...
```
Task(
  prompt="Read E:/nt170/wallhack/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/nt170/wallhack/.opencode/get-shit-done/templates/VALIDATION.md`
